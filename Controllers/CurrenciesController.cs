...
namespace SQLiteWebApi.Controllers
{
    public class CurrenciesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CurrencyId,CurrencyName,ExchangeRate")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CurrencyId,CurrencyName,ExchangeRate")] Currency currency)
        {
